 ...
 * 弱引用锁
 * 将锁的销毁交个JAVA GC来完成
 * https://blog.csdn.net/zhawenting/article/details/81632572
 * https://blog.csdn.net/qq_38245668/article/details/105891161
 * 可以做到针对同一个key加锁。所得粒度更加小。
 */
public class WeakRefHashLock {
    ...
    class LockWeakReference extends WeakReference<ReentrantLock> {
        ...
        /**
         * ReferenceQueue<? super ReentrantLock> q 这个东西就是用来定义  将过期的引用放到这个队列中。
         */
